...
?>
<h2><?php esc_html_e('Link Page Analytics', 'generatepress_child'); ?></h2>
...
<div id="bp-analytics-charts" style="margin-top: 2em;">
    <h3><?php esc_html_e('Views & Clicks Over Time', 'generatepress_child'); ?></h3>
    <div class="chart-container" style="position: relative; height:400px; width:100%">
        <canvas id="bp-views-clicks-chart"></canvas>
    </div>

    <h3 style="margin-top: 2em;"><?php esc_html_e('Top Links', 'generatepress_child'); ?></h3>
    <table class="wp-list-table widefat striped" id="bp-top-links-table">
        <thead>
            <tr>
