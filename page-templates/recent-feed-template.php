<?php
/*
 * Template Name: Recent Posts Feed
 * Description: A page template to show either topics or replies that are recent in the forum.
 */
...
if ($isUserProfile) {
    ...
    echo '<h1>Recent Posts</h1>'; // Changed title to Recent Posts
}
...
// Fetch the recent posts based on the filter
$query = ($filter === 'topics') ? extrachill_get_recent_forum_topics($current_page) : extrachill_get_recent_forum_replies($current_page);
        ...
        <?php if ($query->have_posts()): ?>
            <ul id="bbp-forum-<?php echo $current_user_id; ?>" class="bbp-topics">
                <?php while ($query->have_posts()): $query->the_post();
                    // Determine if the post is a topic or a reply
                            ...
                            <div id="topics-ec">
                                <ul id="bbp-topic-<?php bbp_topic_id(); ?>" <?php bbp_topic_class(); ?>>
                                    <li class="bbp-topic-title">
                                        ...
                                        <div class="upvote">
                                            <span class="upvote-icon" data-post-id="<?php echo $topic_id; ?>"
                                                  data-type="topic" data-nonce="<?php echo wp_create_nonce('upvote_nonce'); ?>"
                                                  role="button" aria-label="Upvote this topic">
...
?>
    <div class="upvote"><span class="upvote-icon" data-post-id="<?php echo $reply_id; ?>" data-type="reply" data-nonce="<?php echo wp_create_nonce('upvote_nonce'); ?>">
        <i class="<?php echo $icon_class; ?> fa-circle-up"></i>
    </span>
        ...
        <div class="author-follow-button">
         ...
         <?php
            ...
            <?php wp_reset_postdata(); ?>
                <?php else: ?>
                    <div class="bbp-template-notice"><p>No recent posts found.</p></div>
                <?php endif; ?>
            </div>
        </div>
