...
<div id="extrch-subscribe-modal" class="extrch-subscribe-modal extrch-modal" style="display: none;" role="dialog" aria-modal="true" aria-labelledby="extrch-subscribe-modal-title">
    ...
    <div class="extrch-subscribe-modal-content extrch-modal-content">
        <button class="extrch-subscribe-modal-close extrch-modal-close" aria-label="<?php esc_attr_e('Close subscription modal', 'generatepress_child'); ?>">&times;</button>
        ...
        <form id="extrch-subscribe-form-modal" class="extrch-subscribe-form">
            ...
            <div class="form-group">
                <label for="subscriber_email_modal" class="screen-reader-text"><?php esc_html_e('Email Address', 'generatepress_child'); ?></label>
                <input type="email" name="subscriber_email" id="subscriber_email_modal" placeholder="<?php esc_attr_e('Your email address', 'generatepress_child'); ?>" required>
            </div>
