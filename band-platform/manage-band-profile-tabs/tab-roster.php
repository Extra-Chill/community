...
<div class="band-profile-content-card">
    <div class="bp-notice bp-notice-info" style="margin-bottom: 1.5em;">
        <p><?php esc_html_e( "All members added to this roster will have permissions to moderate the band's forum, manage this band profile, and manage the associated Extrachill.link page.", 'generatepress_child' ); ?></p>
    </div>
    <?php 
    ...
    if ( $edit_mode && $target_band_id > 0 ) :
        ...
        echo '<p>' . esc_html__('Member management is available when editing an existing band profile.', 'generatepress_child') . '</p>';
    endif; 
    ?>
</div> 