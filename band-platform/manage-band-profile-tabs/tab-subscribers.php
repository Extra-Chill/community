...
<div class="band-profile-content-card subscribers-tab-content" data-fetch-subscribers-nonce="<?php echo esc_attr( wp_create_nonce('extrch_fetch_subscribers_nonce') ); ?>">
    <h3><?php esc_html_e( 'Band Subscribers', 'generatepress_child' ); ?></h3>
    <p><?php esc_html_e( 'This section lists the email subscribers for your band. Including those who subscribed on your link page and those who followed your band and opted-in to share their email address.', 'generatepress_child' ); ?></p>
    ...
    <div class="bp-subscribers-list-actions" style="display: flex; flex-wrap: wrap; gap: 1em; align-items: center;">
        ...
        <label style="display: flex; align-items: center; gap: 0.5em; margin: 0;">
            ...
            <?php esc_html_e('Include already exported subscribers', 'generatepress_child'); ?>
        </label>
        ...
        <a href="<?php echo esc_url( $export_url ); ?>" id="export-subscribers-link" class="button button-primary" style="min-width: 120px; flex: 1 1 200px; max-width: 220px; text-align: center;">
            <?php esc_html_e( 'Export', 'generatepress_child' ); ?>
        </a>
         <?php // Optional: Add a button/form for exporting ALL subscribers if needed later ?>
         <!-- 
         <button type="button" class="button button-secondary" disabled><?php esc_html_e( 'Download All Subscribers (CSV) - Coming Soon', 'generatepress_child' ); ?></button>
          -->
    </div>
    ...
    <div class="bp-subscribers-list">
        ...
        <p class="loading-message"><?php esc_html_e( 'Loading subscribers...', 'generatepress_child' ); ?></p>
        <table class="wp-list-table widefat striped hidden">
            <thead>
                <tr>
                    <th scope="col"><?php esc_html_e( 'Email', 'generatepress_child' ); ?></th>
                    <th scope="col"><?php esc_html_e( 'Username', 'generatepress_child' ); ?></th>
                    <th scope="col"><?php esc_html_e( 'Subscribed At', 'generatepress_child' ); ?></th>
                    <th scope="col"><?php esc_html_e( 'Exported', 'generatepress_child' ); ?></th>
                </tr>
            </thead>
            <tbody>
         ...
         <p class="no-subscribers-message hidden"><?php esc_html_e( 'This band does not have any email subscribers yet.', 'generatepress_child' ); ?></p>
         <p class="error-message hidden" style="color: red;"><?php esc_html_e( 'Could not load subscribers.', 'generatepress_child' ); ?></p>
    </div>
