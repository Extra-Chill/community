...
<div class="link-page-content-card">
    <div id="bp-band-name-section" class="form-group">
        <label for="band_profile_title"><strong><?php esc_html_e('Band Name', 'extra-chill-community'); ?></strong></label>
    ...
    <div id="bp-profile-image-section" class="form-group">
        <label for="link_page_profile_image_upload"><strong><?php esc_html_e('Profile Image', 'extra-chill-community'); ?></strong></label><br>
        ...
        <button type="button" id="bp-remove-profile-image-btn" class="button button-secondary" style="margin-left: 5px;"><?php esc_html_e('Remove Image', 'extra-chill-community'); ?></button>
    ...
    <div id="bp-bio-section" class="form-group">
        <label for="link_page_bio_text"><strong><?php esc_html_e('Bio', 'extra-chill-community'); ?></strong></label>
        ...
        <p class="description bp-link-page-bio-desc">
            ...
            if ($current_band_id) {
                ...
                printf(
                    ...
                    esc_html__('The band name, bio, and profile picture are synced between this link page and the %1$sband profile%2$s.', 'extra-chill-community'),
                    '<a href="' . esc_url($edit_profile_url) . '" target="_blank" rel="noopener">',
                    '</a>'
                );
            } else {
                esc_html_e('The band name, bio, and profile picture are synced between this link page and the band profile.', 'extra-chill-community');
            }
            ?>
        </p>
    </div> 
