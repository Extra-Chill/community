...
<div class="link-page-content-card">
    <h2><?php esc_html_e('General Settings', 'extra-chill-community'); ?></h2>
    <div class="bp-link-settings-section">
        ...
        <label style="display:flex;align-items:center;gap:0.5em;font-weight:600;">
            ...
            <?php esc_html_e('Enable Featured Link', 'extra-chill-community'); ?>
        </label>
        <p class="description" style="margin:0.5em 0 0 1.8em; color:#aaa; font-size:0.97em; margin-bottom: 0.5em;"><?php esc_html_e('Highlight a specific link at the top of your page with a custom thumbnail, title, and description.', 'extra-chill-community'); ?></p>
        <div id="bp-featured-link-select-container" style="margin:0.5em 0 1.5em 1.8em; <?php echo $enable_featured_link ? '' : 'display:none;'; ?>">
            <label for="bp-featured-link-original-id" style="display:block; margin-bottom: 0.3em;"><?php esc_html_e('Select Link to Feature:', 'extra-chill-community'); ?></label>
            <select name="featured_link_original_id" id="bp-featured-link-original-id" style="min-width: 300px;" data-initial-selected-url="<?php echo esc_attr($featured_link_original_url); ?>">
                <option value=""><?php esc_html_e('-- Select a Link --', 'extra-chill-community'); ?></option>
            ...
            <p class="description" style="margin-top: 0.3em; color:#aaa; font-size:0.97em;"><?php esc_html_e('Choose one of your existing links to feature. You can customize its appearance in the \'Customize\' tab.', 'extra-chill-community'); ?></p>
        </div>
        ...
        <label style="display:flex;align-items:center;gap:0.5em;font-weight:600; margin-top:1.5em;">
            ...
            <?php esc_html_e('Enable Link Expiration Dates', 'extra-chill-community'); ?>
        </label>
        <p class="description" style="margin:0.5em 0 1.5em 1.8em; color:#888; font-size:0.97em;"><?php esc_html_e('When enabled, you can set expiration dates for individual links in the "Links" tab. Expired links will be deleted automatically.', 'extra-chill-community'); ?></p>
        ...
        <label style="display:flex;align-items:center;gap:0.5em;font-weight:600;">
            ...
            <?php esc_html_e('Enable Weekly Performance Email', 'extra-chill-community'); ?>
        </label>
        <p class="description" style="margin:0.5em 0 1.5em 1.8em; color:#aaa; font-size:0.97em;"><?php esc_html_e('Receive a weekly summary of your link page performance via email.', 'extra-chill-community'); ?></p>

        <label style="display:flex;align-items:center;gap:0.5em;font-weight:600;">
            <input type="checkbox" name="link_page_redirect_enabled" id="bp-enable-temporary-redirect" value="1" <?php checked($redirect_enabled); ?> />
            <?php esc_html_e('Enable Temporary Redirect', 'extra-chill-community'); ?>
        </label>
        <p class="description" style="margin:0.5em 0 0 1.8em; color:#aaa; font-size:0.97em;"><?php esc_html_e('Redirect visitors from your main extrachill.link URL to a specific link temporarily.', 'extra-chill-community'); ?></p>
        <div id="bp-temporary-redirect-target-container" style="margin:0.5em 0 1.5em 1.8em; <?php echo $redirect_enabled ? '' : 'display:none;'; ?>">
            <label for="bp-temporary-redirect-target" style="display:block; margin-bottom: 0.3em;"><?php esc_html_e('Redirect To:', 'extra-chill-community'); ?></label>
            ...
            <p class="description" style="margin-top: 0.3em; color:#aaa; font-size:0.97em;"><?php esc_html_e('Select one of your existing links to redirect visitors to.', 'extra-chill-community'); ?></p>
        </div>
        ...
        <label style="display:flex;align-items:center;gap:0.5em;font-weight:600; margin-top: 1.5em;">
            ...
            <?php esc_html_e('Disable Inline YouTube Video Player', 'extra-chill-community'); ?>
        </label>
        <p class="description" style="margin:0.5em 0 1.5em 1.8em; color:#aaa; font-size:0.97em;"><?php esc_html_e('By default, YouTube links play directly on the page. Check this box if you prefer YouTube links to navigate to YouTube.com instead.', 'extra-chill-community'); ?></p>
...
<div class="link-page-content-card">
    <h2><?php esc_html_e('Subscription Settings', 'extra-chill-community'); ?></h2>
    <div class="bp-link-settings-section">
        <?php
        ...
        $subscribe_options = array(
            'icon_modal' => __( 'Show Subscribe Icon (opens modal)', 'extra-chill-community' ),
            'inline_form' => __( 'Show Inline Subscribe Form (below links)', 'extra-chill-community' ),
            'disabled' => __( 'Disable Subscription Feature', 'extra-chill-community' ),
        );
        ...
        ?>
        <p style="margin-bottom: 1em;"><?php esc_html_e('Choose how the email subscription option is displayed on your public link page.', 'extra-chill-community'); ?></p>
        ...
        <p class="description" style="color:#888; font-size:0.97em; margin-top:0.5em;">
            <?php esc_html_e('This setting controls the appearance of the email subscription feature on your live link page.', 'extra-chill-community'); ?>
        </p>
        <?php
        ...
        $band_name = isset($data['display_title']) && $data['display_title'] ? $data['display_title'] : __('this band', 'extra-chill-community');
        $subscribe_description_default = sprintf( __( 'Enter your email address to receive occasional news and updates from %s.', 'extra-chill-community' ), $band_name );
        ...
        <div class="bp-link-setting-item" style="margin-top:1.5em;">
            <label for="link_page_subscribe_description" style="display:block; font-weight:600; margin-bottom:0.3em;">
                <?php esc_html_e('Subscribe Form Description', 'extra-chill-community'); ?>
            </label>
            ...
            <p class="description" style="color:#888; font-size:0.97em; margin-top:0.5em;">
                <?php esc_html_e('This text appears in the subscribe modal or inline form on your public link page.', 'extra-chill-community'); ?>
            </p>
        </div>
    </div>
</div>
...
<div class="link-page-content-card">
    <h2 style="margin-bottom: 0.8em;"><?php esc_html_e('Tracking Pixels', 'extra-chill-community'); ?></h2>
    <div class="bp-link-settings-section">
        <div class="bp-link-setting-item" style="margin-bottom: 1.5em;">
            <label for="link_page_meta_pixel_id" style="display:block; font-weight:600; margin-bottom: 0.3em;"><?php esc_html_e('Meta Pixel ID', 'extra-chill-community'); ?></label>
            ...
            <p class="description" style="color:#888; font-size:0.97em; margin-top:0.5em;"><?php esc_html_e('Enter your Meta (Facebook) Pixel ID to track page views and events.', 'extra-chill-community'); ?></p>
        </div>
        ...
        ?>
        <div class="bp-link-setting-item" style="margin-bottom: 1.5em;">
            <label for="link_page_google_tag_id" style="display:block; font-weight:600; margin-bottom: 0.3em;"><?php esc_html_e('Google Tag ID (GA4 / Ads)', 'extra-chill-community'); ?></label>
            ...
            <p class="description" style="color:#888; font-size:0.97em; margin-top:0.5em;"><?php esc_html_e('Enter your Google Tag ID for Google Analytics 4 or Google Ads. This enables tracking page views, events, and allows for targeted advertising campaigns.', 'extra-chill-community'); ?></p>
        </div>
        ...
        <div class="bp-link-setting-item" style="margin-bottom: 1.5em;">
            ...
            <p class="description" style="color:#888; font-size:0.97em; margin-top:0.5em;"><?php esc_html_e('Enter your Google Tag ID for Google Analytics 4 or Google Ads.', 'extra-chill-community'); ?></p>
        </div>
        -->
    </div>
</div>