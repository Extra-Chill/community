...
/* // REMOVED - Moved to manage-link-page-qrcode.js
(function() {
    ...
    if (qrButton && qrModal && qrModalClose && qrImageElement && loadingMessage) {
        qrButton.addEventListener('click', function() {
            ...
            ajaxData.append('action', 'extrch_generate_qr_code');
            ajaxData.append('security_nonce', window.extrchLinkPagePreviewAJAX.nonce); 
            ...
            .then(data => {
                ...
                if (data.success && data.data.qr_image_url) {
                    qrImageElement.src = data.data.qr_image_url;
