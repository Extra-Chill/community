...
<div class="bbp-user-header-card">
    ...
    <div class="bbp-user-header-text-area">
        ...
        <div class="bbp-user-follow-button-area">
                ...
                <a href="<?php echo esc_url( bbp_get_user_profile_edit_url( bbp_get_displayed_user_id() ) ); ?>" class="extrachill-edit-profile-button" style="margin-left: 10px;"><?php esc_html_e('Edit Profile', 'generatepress_child'); ?></a>
            <?php endif; ?>
        </div>
